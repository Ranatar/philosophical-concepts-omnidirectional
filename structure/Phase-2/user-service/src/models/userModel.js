/**
 * User Model
 * Defines the user entity structure and methods
 */

const { v4: uuidv4 } = require('uuid');
const { ROLE_USER } = require('../../../shared/constants/roles');
const { USER_ACTIVE } = require('../../../shared/constants/statuses');
...
class UserModel {
  ...
  /**
   * Convert the user to a profile object
   ...
   * @returns {UserModel} Updated user instance
   */
  update(userData = {}) {
  ...
  /**
   * Create a UserModel instance from a database row
   * @param {Object} row - Database row
   * @returns {UserModel} User instance
   */
